...
function Skill({ skill, fromLeft }: Props) {
  return (
    <div className="group relative flex cursor-pointer">
      ...
      />
      <div className="absolute opacity-0 group-hover:opacity-100 transition duration-300 ease-in-out group-hover:bg-white h-20 w-20 xl:h-24 xl:w-24 rounded-full z-0">
